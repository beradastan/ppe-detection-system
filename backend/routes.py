...
FrameRequest ,LoginRequest ,RegisterRequest ,

UserResponse ,LoginResponse ,RegisterResponse ,LogsResponse ,

LogStatsResponse ,SupervisorResponse 
...
async def register (body :RegisterRequest ):
    ...
    try :
        ...
        logger .info (f"Kullanıcı kayıt verisi: username={body .username }, role={role }, email={body .email }, full_name={body .full_name }, supervisor_id={supervisor_id_to_set }")
...
async def process_frame_endpoint (request :FrameRequest ):
    ...
    try :
        ...
        logger .info (f"Detection result user info - ID: {detection_result .get ('user_id')}, Username: {detection_result .get ('username')}, Role: {detection_result .get ('user_role')}")
...
async def random_jwt (user :str ="ahmet_yilmaz",role :str ="worker"):
    ...
    try :
        ...
        "user":{"id":user_id ,"username":user ,"role":role }
